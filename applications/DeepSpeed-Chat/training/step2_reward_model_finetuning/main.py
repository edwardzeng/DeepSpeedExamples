...
from utils.utils import get_optimizer_grouped_parameters, save_zero_three_model, load_hf_tokenizer
from utils.ds_utils import get_train_ds_config
from utils.module.lora import convert_linear_layer_to_lora, convert_lora_to_linear_layer
from utils.module.lora import only_optimize_lora_parameters, make_model_gradient_checkpointing_compatible
...
def main():
    ...
    ds_config['train_batch_size'] = args.per_device_train_batch_size * get_world_size * args.gradient_accumulation_steps
    ...
    for epoch in range(args.num_train_epochs):
        ...
        print_rank_0(f"Beginning of Epoch {epoch_desc}, Total Micro Batches {len(train_dataloader)}", args.global_rank)
        model.train()
        mean_loss = 0
